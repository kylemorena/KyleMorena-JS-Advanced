      ...
      if(match.aqiDescription.value!='Not available'){
        ...
        <div class="card rounded-sm border-0 text-center card-height">
          ...
          <div class="card-body d-flex align-items-center justify-content-center flex-column">
            <h3 class="card-title p-2 rounded-sm bg-dark">
            ...
            <p class="lead card-text mb-0 p-1">${match.aqiDescription.health}</p>
          ...
          <div class="card-footer bg-transparent border-light">${date}</div>
        </div>`
      }else{
        cardContainer.innerHTML = `
        <div class="card border-0 text-center bg-secondary card-height">
          ...
          <div class="card-body d-flex text-center justify-content-center flex-column">
            <h3 class="card-title p-2 rounded bg-dark">
              <span style="color:${match.aqiDescription.color}">${match.aqi}</span> 
              <span style="color:${match.aqiDescription.color}">${match.aqiDescription.level}</span>
            </h3>
          </div>
