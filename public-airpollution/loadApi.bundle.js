...
function addQualityDesc(aqiValue) {
  var json = __webpack_require__(/*! ../json/qualityLevels.json */ "./src/json/qualityLevels.json");
...
var loadApi = {
  search: function () {
    var _search = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee(keyword, token) {
      var response, dati;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return fetch("https://api.waqi.info/search/?token=".concat(token, "&keyword=").concat(keyword));
            ...
            case 6:
              dati = _context.sent;
              dati.data.forEach(function (element) {
                var aqi = Number(element.aqi);
                element["aqiDescription"] = addQualityDesc(aqi);
              });
              return _context.abrupt("return", dati.data);

            case 11:
              _context.prev = 11;
              _context.t0 = _context["catch"](0);
              console.log("loadApi.WAQI error: ".concat(_context.t0));
  ...
  getCityFeed: function () {
    var _getCityFeed = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(name, token) {
      var response, dati;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return fetch("https://api.waqi.info/feed/".concat(name, "/?token=").concat(token));
            ...
            case 6:
              ...
              console.log();
              return _context2.abrupt("return", dati.data);

            case 12:
              _context2.prev = 12;
              _context2.t0 = _context2["catch"](0);
              console.log("loadApi.getCityFeed error: ".concat(_context2.t0));
    ...
    function getCityFeed(_x3, _x4) {
      return _getCityFeed.apply(this, arguments);
    }

    return getCityFeed;
  }(),
  mapQueries: function () {
    var _mapQueries = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3(bounds, token, currPos) {
      var response, dati;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return fetch("https://api.waqi.info/map/bounds/?latlng=".concat(bounds, "&token=").concat(token));
            ...
            case 6:
              dati = _context3.sent;
              dati.data.forEach(function (element, index, arr) {
                var aqi = Number(element.aqi);
                element["aqiDescription"] = addQualityDesc(aqi);
              ...
              return _context3.abrupt("return", dati.data);

            case 11:
              _context3.prev = 11;
              _context3.t0 = _context3["catch"](0);
              console.log("loadApi.getPosition error: ".concat(_context3.t0));
    ...
    function mapQueries(_x5, _x6, _x7) {
      return _mapQueries.apply(this, arguments);
    }

    return mapQueries;
  }(),
  geoLatLon: function () {
    var _geoLatLon = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4(latlon, token) {
      var response, dati;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return fetch("https://api.waqi.info/feed/geo:".concat(latlon, "/?token=").concat(token));
            ...
            case 5:
              dati = _context4.sent;
              dati.data["aqiDescription"] = addQualityDesc(Number(dati.data.aqi));
              return _context4.abrupt("return", dati.data);
    ...
    function geoLatLon(_x8, _x9) {
      return _geoLatLon.apply(this, arguments);
    }

    return geoLatLon;
  }(),
  qualityLevels: function () {
    var _qualityLevels = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5() {
      var json;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return __webpack_require__(/*! ../json/qualityLevels.json */ "./src/json/qualityLevels.json");
    ...
    function qualityLevels() {
      return _qualityLevels.apply(this, arguments);
    }
...
"use strict";
module.exports = JSON.parse("{\"nodata\":{\"value\":\"Not available\",\"color\":\"gray\",\"level\":\"Not available\",\"health\":\"\",\"cautionary\":\"none\"},\"data\":[{\"value\":\"0-50\",\"color\":\"#009966\",\"level\":\"Good\",\"health\":\"Air quality is considered satisfactory, and air pollution poses little or no risk\",\"cautionary\":\"none\"},{\"value\":\"51-100\",\"color\":\"#FFDE33\",\"level\":\"Moderate\",\"health\":\"Air quality is acceptable; however, for some pollutants there may be a moderate health concern for a very small number of people who are unusually sensitive to air pollution.\",\"cautionary\":\"Active children and adults, and people with respiratory disease, such as asthma, should limit prolonged outdoor exertion.\"},{\"value\":\"101-150\",\"color\":\"#FF9933\",\"level\":\"Unhealthy for Sensitive Groups\",\"health\":\"Members of sensitive groups may experience health effects. The general public is not likely to be affected.\",\"cautionary\":\"Active children and adults, and people with respiratory disease, such as asthma, should limit prolonged outdoor exertion.\"},{\"value\":\"151-200\",\"color\":\"#CC0033\",\"level\":\"Unhealthy\",\"health\":\"Everyone may begin to experience health effects; members of sensitive groups may experience more serious health effects\",\"cautionary\":\"Active children and adults, and people with respiratory disease, such as asthma, should avoid prolonged outdoor exertion; everyone else, especially children, should limit prolonged outdoor exertion\"},{\"value\":\"251-300\",\"color\":\"#660099\",\"level\":\"Very Unhealthy\",\"health\":\"Health warnings of emergency conditions. The entire population is more likely to be affected\",\"cautionary\":\"Active children and adults, and people with respiratory disease, such as asthma, should avoid all outdoor exertion; everyone else, especially children, should limit outdoor exertion.\"},{\"value\":\"300+\",\"color\":\"#7E0023\",\"level\":\"Hazardous\",\"health\":\"Health alert: everyone may experience more serious health effects\",\"cautionary\":\"Everyone should avoid all outdoor exertion\"}]}");
...
/******/ 	(() => {
/******/ 		__webpack_require__.hmrF = () => ("loadApi." + __webpack_require__.h() + ".hot-update.json");
/******/ 	})();
/******/ 	
